...
from order.views import OrdersView, OrderView, AddOrderView,EditOrderView, UploadGalleryPhotoView, OrderRespondView, \
...
urlpatterns = [
    url('edit_order', EditOrderView.as_view(), name='edit_order'),
    url(
        'api/orders',
