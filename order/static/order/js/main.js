                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section id="not-found" class="center margin-top-50 margin-bottom-25">
                            ...
                            <p>This category doesn't have active tasks ;( </p>
                        </section>
                        <div class="row">
                            <div class="col-xl-8 offset-xl-2">
                                <div class="intro-banner-search-form not-found-search margin-bottom-50">
                                    <div class="intro-search-field ">
								        <input id="intro-keywords" type="text" disabled placeholder="Create task!">
							        </div>
                                    <div class="intro-search-button">
                                        <button id="first-order" class="button ripple-effect">Create</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        orders_div.append(
            ...
            <div class="task-listing-details">
                <div class="task-listing-description">
                    <h3 class="job-listing-title">
                        ...
                        ${
            order.is_my ?
                '<span class="dashboard-status-button green">Your task</span>' :
                ''
            }
                    </h3>
            ...
            order.is_fixed_price ?
                ...
                order.price_low + " - " + order.price_high + " USD"
                    ...
                    ${
            order.is_respond ?
                '<span class="button">You have placed a bid</span>' :
                ''
            }
                </div>
            </div>
